창원대 정보통신공학과 2019 하계 딥러닝 특강 Project
=============================================
## 목차
* 개요
...
* 결과물들로부터 재미있는 점을 발견했다. 학습 후 Content Image를 다시 그려낼 때 주로 면 부분에 많은 영향을 미쳤다. 위 결과물에서도 보이듯, Content Image선의 형태와 Result Image선의 형태가 거의 일치했다.
* 또한, Content Image에서 보이는 여러 요소 중 Style Image의 화풍과 유사한 구성요소는 좀 더 자연스레 그려내는 듯 보인다. 특히, Test(1)에서 확연히 볼 수 있었다. *Farmer's Life*는 전체적으로 선의 존재감 보다는 면의 존재감이 크고, 대체로 탁하고 흐리다. Content Image에 나타난 여러 요소(건물, 하늘, 구름 등)중 구름이 *Farmer's Life*의 화풍과 가장 유사한데, 직선이 강조되는 건물과 비교했을 때 보다 자연스럽게 표현되었다고 느껴진다.
<br></br>
